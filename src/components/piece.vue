<template>
  ...
  <div v-else-if="owner === 'white'">
    <div v-if="piece === 'pawn'"><svg class="white-piece"><use href="#pawn-icon"></use></svg></div>
    <div v-else-if="piece === 'rook'"><svg class="white-piece"><use href="#rook-icon"></use></svg></div>
    <div v-else-if="piece === 'knight'"><svg class="white-piece"><use href="#knight-icon"></use></svg></div>
    <div v-else-if="piece === 'bishop'"><svg class="white-piece"><use href="#bishop-icon"></use></svg></div>
    <div v-else-if="piece === 'queen'"><svg class="white-piece"><use href="#queen-icon"></use></svg></div>
    <div v-else-if="piece === 'king'"><svg class="white-piece"><use href="#king-icon"></use></svg></div>
  </div>
  <div v-else>
    <div v-if="piece === 'pawn'"><svg class="black-piece"><use href="#pawn-icon"></use></svg></div>
    <div v-else-if="piece === 'rook'"><svg class="black-piece"><use href="#rook-icon"></use></svg></div>
    <div v-else-if="piece === 'knight'"><svg class="black-piece"><use href="#knight-icon"></use></svg></div>
    <div v-else-if="piece === 'bishop'"><svg class="black-piece"><use href="#bishop-icon"></use></svg></div>
    <div v-else-if="piece === 'queen'"><svg class="black-piece"><use href="#queen-icon"></use></svg></div>
    <div v-else-if="piece === 'king'"><svg class="black-piece"><use href="#king-icon"></use></svg></div>
  </div>
  <div id="svg-container">
    <svg xmlns="http://www.w3.org/2000/svg">
      <symbol id="pawn-icon" fill="currentColor" viewBox="0 0 298 298">
    ...
    <svg xmlns="http://www.w3.org/2000/svg">
      <symbol id="rook-icon" fill="currentColor" viewBox="0 0 298 298">
    ...
    <svg xmlns="http://www.w3.org/2000/svg">
      <symbol id="knight-icon" fill="currentColor" viewBox="0 0 298 298">
      <path d="M210.952,116c14.912,0,27.037-12.088,27.037-27s-10.945-25.013-26.964-30.666c-11.333-4-18.018-10.823-23.009-19.412
    ...
    <svg xmlns="http://www.w3.org/2000/svg">
      <symbol id="bishop-icon" fill="currentColor" viewBox="0 0 298 298">
    ...
    <svg xmlns="http://www.w3.org/2000/svg">
      <symbol id="queen-icon" fill="currentColor" viewBox="0 0 298 298">
    ...
    <svg xmlns="http://www.w3.org/2000/svg">
      <symbol id="king-icon" fill="currentColor" viewBox="0 0 298 298">
      <path d="M197.333,256h-1.641c1.878-3.337,7.061-14.536-0.605-25.6c-7.554-10.905-21.491-39.547-20.904-64.401
